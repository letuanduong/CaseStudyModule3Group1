    ...
    <div align="center">
        ...
        <form method="post" action="${pageContext.request.contextPath}/product?action=create">
            <table border="1" cellpadding="5">
                <tr>
                    <th>Product Name:</th>
                    <td><input type="text" size="45" name="product_name"></td>
                </tr>

                <tr>
                    <th>Product Brand:</th>
                    <td><input type="text" size="45" name="product_brand"></td>
                </tr>

                <tr>
                    <th>Product Price:</th>
                    <td><input type="text" size="45" name="product_price"></td>
                </tr>

                <tr>
                    <th>Product Amount:</th>
                    <td><input type="text" size="45" name="product_amount"></td>
                </tr>

                <tr>
                    <th>Product Description:</th>
                    <td><input type="text" size="45" name="product_description"></td>
                </tr>
